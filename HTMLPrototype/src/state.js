...
export const STOCK_TEMPLATES = {
  'Portra 400': {
    ...
    global: { reversal: 0, stackingStrength: 0, maskDensity: 0.42, maskHue: 28, dirInhibition: 0.35, baseTintR: 1.0, baseTintG: 0.97, baseTintB: 0.94, scanExposure: 3.0 },
  },
  'Gold 200': {
    layers: [
    ...
    global: { reversal: 0, stackingStrength: 0, maskDensity: 0.50, maskHue: 32, dirInhibition: 0.25, baseTintR: 1.0, baseTintG: 0.95, baseTintB: 0.88, scanExposure: 3.0 },
  },
  'Velvia 50': {
    layers: [
    ...
    global: { reversal: 1, stackingStrength: 0, maskDensity: 0, maskHue: 0, dirInhibition: 0.60, baseTintR: 0.99, baseTintG: 0.99, baseTintB: 1.0, scanExposure: 3.0 },
  },
  'Kodachrome 64': {
    layers: [
    ...
    global: { reversal: 1, stackingStrength: 0, maskDensity: 0, maskHue: 0, dirInhibition: 0.50, baseTintR: 1.0, baseTintG: 0.98, baseTintB: 0.96, scanExposure: 3.0 },
  },
  'Ilford HP5': {
    layers: [
    ...
    global: { reversal: 0, stackingStrength: 0, maskDensity: 0, maskHue: 0, dirInhibition: 0, baseTintR: 1.0, baseTintG: 1.0, baseTintB: 1.0, scanExposure: 3.0 },
  },
  'Kodak Tri-X': {
    layers: [
    ...
    global: { reversal: 0, stackingStrength: 0, maskDensity: 0, maskHue: 0, dirInhibition: 0, baseTintR: 0.99, baseTintG: 0.99, baseTintB: 0.98, scanExposure: 3.0 },
  },
};
...
export const BLANK_RECIPE = {
  ...
  global: { reversal: 0, stackingStrength: 0, maskDensity: 0.35, maskHue: 28, dirInhibition: 0.30, baseTintR: 1.0, baseTintG: 0.97, baseTintB: 0.94, scanExposure: 3.0 },
};
