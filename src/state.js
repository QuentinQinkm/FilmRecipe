...
export const STOCK_TEMPLATES = {
  'Portra 400': {
    ...
    global: { reversal: 0, stackingStrength: 0, maskDensity: 0.42, maskHue: 28, dirInhibition: 0.35, baseTintWarmth: 0.5, scanExposure: 3.0, grainSoftness: 1.50, halation: 0.25 },
  },
  'Gold 200': {
    layers: [
    ...
    global: { reversal: 0, stackingStrength: 0, maskDensity: 0.50, maskHue: 32, dirInhibition: 0.25, baseTintWarmth: 1.0, scanExposure: 3.0, grainSoftness: 1.20, halation: 0.20 },
  },
  'Velvia 50': {
    layers: [
    ...
    global: { reversal: 1, stackingStrength: 0, maskDensity: 0, maskHue: 0, dirInhibition: 0.60, baseTintWarmth: -0.08, scanExposure: 3.0, grainSoftness: 1.00, halation: 0 },
  },
  'Kodachrome 64': {
    layers: [
    ...
    global: { reversal: 1, stackingStrength: 0, maskDensity: 0, maskHue: 0, dirInhibition: 0.50, baseTintWarmth: 0.33, scanExposure: 3.0, grainSoftness: 1.00, halation: 0 },
  },
  'Ilford HP5': {
    layers: [
    ...
    global: { reversal: 0, stackingStrength: 0, maskDensity: 0, maskHue: 0, dirInhibition: 0, baseTintWarmth: 0, scanExposure: 3.0, grainSoftness: 0.80, halation: 0 },
  },
  'Kodak Tri-X': {
    layers: [
    ...
    global: { reversal: 0, stackingStrength: 0, maskDensity: 0, maskHue: 0, dirInhibition: 0, baseTintWarmth: 0.08, scanExposure: 3.0, grainSoftness: 0.70, halation: 0 },
  },
};
...
export const BLANK_RECIPE = {
  ...
  global: { reversal: 0, stackingStrength: 0, maskDensity: 0.35, maskHue: 28, dirInhibition: 0.30, baseTintWarmth: 0.5, scanExposure: 3.0, grainSoftness: 1.00, halation: 0 },
};
...
export const GLOBAL_CONTROLS = [
  ...
  ['grainSoftness', 'Grain softness', 'Grain softness', '\u00d7', 0.5, 3.0, 0.05, 2],
